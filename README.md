...
- نسخه پنل 3.6.0 ( اخرین نسخه پنل سنایی ) میباشد .
- مشکلات تعریف حجم کانفیگ در پنل و وضعیت سیستم فیکس شده است .


- جهت دریافت اخبار پنل ها و بروزرسانی ها در کانال ما عضو باشید 
t.me/giftparsi_ir
